...
import ua.com.goit.command.project.FindProjectById;
...
public class CompanyMenu implements Command {
    ...
    public void execute() {
        ...
        view.write(String.format("Type %s to look for company with particular Id", "\033[0;93m" + FindCompanyById.FIND_COMPANY_BY_ID + "\033[0m"));
